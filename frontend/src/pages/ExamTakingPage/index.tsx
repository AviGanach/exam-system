...
const ExamTakingPage: React.FC<ExamTakingPageProps> = ({ user }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // תרחיש A: ציון + סקירה מלאה → קואנפירם עם ציון ומעבר לסקירה
      // תרחיש B:  סקירה למידה → קואנפירם למידה ומעבר לסקירה (ללא ציון)
      // תרחיש C: ציון בלבד → אלרט עם ציון וחזרה לדף הבית
      // תרחיש D: אלרט סטנדרטי וחזרה לדף הבית
